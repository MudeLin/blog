...
module.exports = function(app){
	...
	app.get('/tags/:tag',function(req,res){
		Post.getTag(req.params.tag,function(err,posts){
			...
			req.flash('success','TAG:' +  req.params.tag);
			res.render('tag',{
				title:'标签文章',
				posts:posts,
				user:req.session.user,
	...
	app.get('/u/:name/:day/:title',function(req,res){
		Post.getOne(req.params.name,req.params.day,req.params.title,
			function(err,post){
				if(err){
					req.flash('error',"跳转失败");
					return res.redirect('/');
				}
				req.flash('success','独立文章');
				res.render('article',{
		...
		Post.edit(req.params.name,req.params.day,req.params.title,
			function(err,post){
				...
				Post.reprint(reprint_from,reprint_to,function(err,post){
					...
					var url='/u/'+post.name+'/'+post.time.day+'/'
					+ post.title;
					res.redirect(url);
				});
			});
